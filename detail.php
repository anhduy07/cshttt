...
<div class="container" style="margin-top: 100px; margin-bottom: 20px;">
	<div class="row">
		...
		<div class="col-md-6">
			...
			<button class="btn btn-primary" style="margin-top: 30px; width: 100%; border-radius: 3px; font-size: 20px;" onclick="addCart(<?=$product['id']?>, $('[name=num]').val())">

...
<body style="background-image: url(../../assets/photos/login.jpg); background-size: cover; background-repeat: no-repeat;">
	<div class="container">
			...
			<div class="panel-body">
				<form method="post">
					<div class="form-group">
					  ...
					  <input required="true" type="email" class="form-control" id="email" placeholder="-----Nhập email của bạn-----" name="email" value="<?=$email?>">
					</div>
					<div class="form-group">
					  <label for="pwd">Mật Khẩu:</label>
					  <input required="true" type="password" class="form-control" id="pwd" placeholder="-----Nhập mật khẩu của bạn-----" name="password" minlength="6">
					</div>
					<p>
